...
public class OpenApiController {
	...
	String OpenApiInsert(Model model,CompanyVO vo) throws Exception {		
        ...
        urlBuilder.append("?" + URLEncoder.encode("serviceKey","UTF-8") + "=sHIdSSRsOkV8ZTrEtbk229bRzUxbydoWI7GODvHOCC2HBNyFVx9tGnbAcDl311zfb%2B93s7F9yw5S%2BFYU20uqQQ%3D%3D"); /*Service Key (일반인증키)*/
	...
	@RequestMapping("/EViInsert.do")
	String EViInsert(Model model,EvSearchVO vo) throws Exception {		
	...
	return "/company/company_selectAll.jsp";
	}
	
	@RequestMapping("/EVlist.do")
    String EVlist ( EvSearchVO  vo , Model model ) {
		model.addAttribute("li",service.selectAllEv(vo));
	return "/company/company_Evlist.jsp";
	}
	
	@RequestMapping("/CplistMap.do")
    String CplistMap ( CompanyVO  vo , Model model ) {
		model.addAttribute("li",service.selectAll(vo));
	return "/company/company_openMap.jsp";
	}
	
	@RequestMapping("/CompanyselectOne.do")
    String companyselectOne ( CompanyVO  vo , Model model ) {
		model.addAttribute("m",service.selectOne(vo));
	return "/company/company_selectOne.jsp";
	}

	@RequestMapping("/EvlistMap.do")
    String EvlistMap ( EvSearchVO  vo , Model model ) {
		model.addAttribute("li",service.selectAllEv(vo));
	return "/company/company_EvMap.jsp";
	}
	
	@RequestMapping("/EVselectOne.do")
    String EVselectOne ( EvSearchVO  vo , Model model ) {
		model.addAttribute("m",service.selectOneEv(vo));
	return "/company/company_EvlistOne.jsp";
	}
}
